...
vars.btnLockParams = uicontrol('Style','pushbutton',...
    'String','Apply params to all channels',...
    'TooltipString', 'Apply parameters of the current channel to remaining channels',...
...
% Callback functions
    ...
    function updateView(retainZoom)
        ...
        if(vars.options.showRectifiedEmg)
            ...
            plot(absc, dat, 'LineWidth', vars.options.lineWidth);
        end
